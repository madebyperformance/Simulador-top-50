...
if st.button('Calcular nova posição'):
    ...
    if ranking > 0:
        ...
        st.write("<span class='css-10trblm' style='font-size: 24px; font-family: Barlow; position: relative; left: -50px;'>Sua posição antiga era: <span style='color: #9966FF; font-weight: bold;'>122º</span></span>", unsafe_allow_html=True)
