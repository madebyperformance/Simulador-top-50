...
if st.button('Calcular nova posição'):
    ...
    if ranking > 0:
        ...
        st.write(f"<span style='font-family: Barlow; color: black;font-size: 20px;'>Sua posição antiga era: </span><span style='color: #9966ff'>{rank_antigo}</span>", unsafe_allow_html=True)
